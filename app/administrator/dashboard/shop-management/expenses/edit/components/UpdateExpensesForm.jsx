...
import DateRange from "@/app/administrator/dashboard/components/DateRange";

const defaultValues = {
  invoiceNumber: 223449,
  supplier: "MS electronics limited",
...
const schema = z.object({
  ...
  supplierCode: z.string().min(1, "Supplier is required"),
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="w-full">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 xl:gap-10 mb-6 xl:mb-10 border-b border-[#D0D5DD] pb-4">
        <FormSelect
          ...
          options={[
            { value: "2250", label: "MS electronics limited" },
      ...
      <div>
        <DateRange
          start={defaultValues.startDate}
          end={defaultValues.endDate}
          fromLabel="Date paid"
          toLabel="Expire date"
        />
