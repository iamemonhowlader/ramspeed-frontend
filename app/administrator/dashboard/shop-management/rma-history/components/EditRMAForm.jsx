...
const initialFormData = {
  ...
  afterImage: null,
  beforeImageLink:
    "https://static.vecteezy.com/system/resources/thumbnails/053/425/986/small/dslr-camera-on-wet-ground-autumn-leaves-photo.jpeg",
  afterImageLink:
    "https://static.vecteezy.com/system/resources/thumbnails/053/425/986/small/dslr-camera-on-wet-ground-autumn-leaves-photo.jpeg",
  ...
  brand: "Asus",
  model: "Rog Strix G15",
  charger: { no: false, yes: true },
  battery: { no: true, yes: false },
  sdCard: { no: false, yes: true },
      ...
      <div className="mx-auto bg-white rounded-2xl border-[#dedede] shadow-xl p-6 md:p-8 gap-12 flex flex-col">
        ...
        <div className="">
          <label className="text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
            Password type <DevicePasswordTermsToolTip />
          </label>
          <select
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-end">
          <Button onClick={() => notImplemented()} variant={"outline"}>
            Cancel
          </Button>
          <Button onClick={() => notImplemented()}>Update</Button>
        </div>
