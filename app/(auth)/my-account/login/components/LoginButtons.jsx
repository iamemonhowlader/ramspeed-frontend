    ...
    <div className="lg:w-1/2 p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
      <div className="max-w-md mx-auto w-full flex flex-col gap-6 lg:gap-12">
        ...
        <div className="space-y-8">
          ...
          <button className="w-full bg-white hover:bg-gray-50 text-primary font-semibold py-4 px-6 rounded-md border-2 border-primary transition-colors duration-200 cursor-pointer">
            B2B Customer
          </button>
