...
const TagPage = ({ params }) => {
  ...
  // Build a minimal navigation context so ShopNowHeading renders the tag as title
  const tagNavigation = [{ text: tag || "Shop Now", slug: tag }];
    ...
    <div className="bg-[#F8F8F8]">
      <div className="container mx-auto px-4 lg:px-0">
        ...
        <div className="py-8 sm:py-12">
          <ShopNowHeading slug={tag} navigation={tagNavigation} />
